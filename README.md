...
```bash
git clone https://github.com/bO-05/ai-decorator
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/bO-05/ai-decorator&env=REPLICATE_API_KEY&project-name=ai-decorator&repo-name=ai-decorator)
